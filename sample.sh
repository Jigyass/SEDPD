...
python3 SamplingDicts/t2e1.py &
python3 SamplingDicts/t2e2.py &
python3 SamplingDicts/t2e3.py &
python3 SamplingDicts/t2e4.py &
python3 SamplingDicts/t2e5.py &
python3 SamplingDicts/t2e6.py &
python3 SamplingDicts/t2e7.py &
python3 SamplingDicts/t2e8.py &
